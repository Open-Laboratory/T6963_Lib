...
#define GLCD_DATA_PIN		PINA		//Arduino Mega Pins 49-42
...
#define GLCD_WR 		1
#define GLCD_RD			2
#define GLCD_CE			0  //Should be able to XNOR this with WR and RD
#define GLCD_CD			3
...
public:
  ...
  void drawPic(unsigned int, unsigned int, const PROGMEM unsigned char *, unsigned int, unsigned int);
  void drawAnim(unsigned int, unsigned int, const PROGMEM unsigned char **, int, unsigned int, unsigned int);
